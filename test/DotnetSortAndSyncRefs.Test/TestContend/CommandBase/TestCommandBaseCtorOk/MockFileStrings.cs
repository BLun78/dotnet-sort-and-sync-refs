...
namespace DotnetSortAndSyncRefs.Test.TestContend.CommandBase.TestCommandBaseCtorOk
{
    internal static class MockFileStrings
    {
        public static string GetDirectoryPackagesProps()
        {
            return
"""
<Project>
...
""";
        ...
        public static string GetTestDotnetCsproj()
        {
            return
"""
...
""";
        ...
        public static string GetTestNetStandardCsproj()
        {
            return
"""
<Project Sdk="Microsoft.NET.Sdk">
